<x-shopper::empty-state
    ...
    :content="__('shopper-customer-groups::messages.empty')"
>
    @can('customers.create')
        <x-slot:action>
            <x-filament::button type="button" icon="untitledui-plus" wire:click="mountAction('createGroup')">
                {{ __('shopper-customer-groups::messages.actions.add') }}
            </x-filament::button>
        </x-slot>
    @endcan
